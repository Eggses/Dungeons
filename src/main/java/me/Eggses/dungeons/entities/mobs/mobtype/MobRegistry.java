...
public class MobRegistry {
    ...
    public MobRegistry(JavaPlugin plugin, MobUtility mobUtility,TextFormatter textFormatter) {
        this.plugin = plugin;
    ...
    public void registerMobs() {
        ...
        mobPresets.put(MobType.ENCHANTER, new Enchanter(plugin, mobUtility, textFormatter).getBuilderConsumer());
